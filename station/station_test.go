...
func Test_NearestStations(t *testing.T) {
	...
	stations := []Station{
		Station{"1", "", Status{}, location.Address{"", "", "", "", location.Location{32.0618, 34.7844}}}, //Distance 540m
		Station{"2", "", Status{}, location.Address{"", "", "", "", location.Location{32.0657, 34.7831}}}, //Distance 342m
		Station{"3", "", Status{}, location.Address{"", "", "", "", location.Location{32.0629, 34.7799}}}, //Distance 189m
		Station{"4", "", Status{}, location.Address{"", "", "", "", location.Location{32.0685, 34.7783}}}, //Distance 454m
		Station{"5", "", Status{}, location.Address{"", "", "", "", location.Location{32.0653, 34.7766}}}, //Distance 303m
	}
